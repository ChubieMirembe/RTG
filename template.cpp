...
private:
    ...
    static const std::vector<uint16_t> Quad_indices;
...
const std::vector<Vertex> HelloTriangleApplication::Quad_vertices = {
...
const std::vector<uint16_t> HelloTriangleApplication::Quad_indices = {
    0, 1, 2, 2, 3, 0
};
